...
const technologies = [
    ...
    },
    {
        name: "AWS",
        color: "#FF9900",
        // AWS simplified cloud icon path
...
export function TechnologiesSection() {
    return (
        <section id="tecnologias" className="relative py-24 md:py-32 px-4 sm:px-6 overflow-hidden">
            {/* Subtle background glow */}
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-radial from-white/[0.02] to-transparent rounded-full blur-3xl" />
            </div>
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                {/* Grid de tecnologías */}
                <motion.div
                    className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-6 md:gap-8 lg:gap-10"
                        ...
                        >
                            ...
                            <div className="relative w-16 h-16 sm:w-18 sm:h-18 md:w-20 md:h-20 flex items-center justify-center">
                                ...
                                <div
                                    ...
                                    style={{ backgroundColor: tech.color, opacity: 0 }}
                                />
                                <div
                                ...
                                {/* Card background */}
                                <div className="absolute inset-0 rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.05] group-hover:border-white/[0.15] group-hover:bg-white/[0.06] transition-all duration-300" />

                                {/* Icon */}
                                <div className="relative z-10 w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
                                    {tech.isLucide ? (
                                        <Sparkles
                                        ...
                                        <BrandIcon
                                            path={tech.path!}
                                            color={tech.color}
                                            className="w-full h-full transition-all duration-300 opacity-80 group-hover:opacity-100"
                                        />
                                    )}
                                </div>
                            </div>
                            ...
                            {/* Tech name */}
                            <span className="mt-3 text-xs sm:text-sm text-gray-500 group-hover:text-white transition-colors duration-300 font-medium text-center">
                                {tech.name}
                            </span>
                        </motion.div>
                    ))}

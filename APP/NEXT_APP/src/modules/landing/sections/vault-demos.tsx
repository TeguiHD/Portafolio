...
import { Lock, TrendingUp, TrendingDown, FileText, Shield, Sparkles, CheckCircle2 } from "lucide-react";

// Finance Demo Component
export function FinanceDemo({ isActive, isWide }: { isActive: boolean; isWide?: boolean }) {
...
export function CVOptimizerDemo({ isActive, isWide }: { isActive: boolean; isWide?: boolean }) {
...
export function SecurityDemo({ isActive }: { isActive: boolean }) {
...
export function RestrictedOverlay({ colorRgb, isActive }: { colorRgb: string; isActive: boolean }) {
...
export function RestrictedBadge({ color, colorRgb, isHovered, isActive }: { color: string; colorRgb: string; isHovered: boolean; isActive: boolean }) {
    return (
        <motion.div
